  ...
  return (
    ...
    <Sidebar />
        ...
        <Container className='jd-list'>
            ...
            <OverlayTrigger placement='bottom' overlay={<Tooltip id="tooltip-disabled">Number of JD's</Tooltip>}><p >Number of JDs ({total})</p></OverlayTrigger><span className='mx-3 fw-bold'>|</span>
      ...
      <Modal show={show1} onHide={handleClose1} size='xl'>
        ...
        <Modal.Body>
          {getdata.map((jd)=>{
            ...
            <Row>
                <Col xs={6}>
            <h6 className='fw-bold mt-5 mb-5 mx-3'> <i className="fas fa-user"></i> Client name: <span className='text-muted'>{jd.company_name}</span></h6>
    ...
    /></span></h6>
            ...
            <h6 className='fw-bold mt-5 mb-5 mx-3'> <i className="fas fa-sort-amount-down me-2"></i> Experience: <span className='text-muted'> {jd.totalexperience}</span></h6>
            <h6 className='fw-bold mt-5 mb-5 mx-3'> <i className="fas fa-book me-2"></i> Education: <span className='text-muted'> {jd.education}</span></h6>
            </Col>
            <Col xs={6}>
            ...
            <h6 className='fw-bold mt-5 mb-5'> <i className="fas fa-map-marked-alt"></i> Company address <span className='text-primary text-small'><i className='fas fa-info-circle ms-2 me-2' onClick={()=>{toast.info("Interview location address can be different from this address")}}/></span>: <span className='text-muted'> {jd.companyadress}</span></h6>
